...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleFinalMessagePart(text) {
         if (text.includes("What made your visit great today?")) {
            ...
            addMessage('concierge', text);
            const tier2Options = ["🤖 Advanced Technology", "🛋️ Comfortable Environment", "🏬 Clean Store", "👍 No Other Highlights"];
        ...
        options.forEach(optionText => {
            ...
            button.onclick = () => {
                if (optionText === "➡️ More options") {
                    ...
                    setTimeout(() => {
                        removeTypingIndicator();
                        const tier2Options = ["🤖 Advanced Technology", "🛋️ Comfortable Environment", "🏬 Clean Store"];
