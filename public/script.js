document.addEventListener('DOMContentLoaded', () => {
    ...
    function addMessage(sender, text, isHtml = false) {
        ...
        // This is the key change: append instead of prepend
    ...
    function processAIResponse(text) { /* ... unchanged ... */ }
    function handleFinalQuestion(question) { /* ... unchanged ... */ }
    ...
    function createEditableDraft(reviewText) {
        ...
        chatBody.appendChild(wrapper); // Changed to append
